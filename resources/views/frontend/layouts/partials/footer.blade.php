    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                <div class="flex items-center space-x-2 mb-4">
                    ...
                    <span class="font-bold text-xl text-gray-900 dark:text-white">Datartech</span>
                </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <a href="mailto:info@datartech.co.ke"> <span class="text-sm text-gray-600 dark:text-gray-400">info@datartech.co.ke</span></a>
                    </li>
                    <li class="flex items-start space-x-3">
                        <svg class="w-5 h-5 text-gray-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="tel:+254726238623"><span class="text-sm text-gray-600 dark:text-gray-400">+254726238623</span></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
            <p class="text-sm text-gray-500 dark:text-gray-400 text-center">
                &copy; {{ date('Y') }} Datartech. All rights reserved.
            </p>
        </div>
    </div>
</footer>